# -*- coding: utf-8 -*-
"""
Created on Thu Oct  4 16:38:57 2018

@author: rvillaco
"""
import time, os, math, json, csv
from collections import Counter
import tweepy

def rest_scrape(terms, tweetAPI, outPath, file_size=500000,fileName=None,max_num_errors=5):
    ...
    with open(logFname,'a+',encoding='utf8') as outLog:
        ...
        for t in terms:
            ...
            if fileName is not None: nPart='{0}_{1}'.format(fileName,t)
            else:   nPart=t
            fname=outPath+r'\{0}_tweets_{1}.json'.format(nPart,file_num)
