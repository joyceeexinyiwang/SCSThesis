...
def rpr():
	...
	path = "data/@nytimes_factual_" +  str(idN)# "data/" + str(idN) + "_" + now.strftime("%Y-%m-%d-%H-%M")
	...
	terms.append("https://twitter.com/nytimes/status/1067244642155094019") # full url of tweet
